function GM:OpenLoadout()
    ...
    function frame:Paint(w, h)
        ...
        draw.SimpleText("Loadout", "Drenched36", w*(1/2), 20, Color(255,255,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    ...
    for i, wep in ipairs(self.Items) do
        ...
        function weppanel:Paint(w, h)
            ...
            if wep.NoPressure then
                draw.SimpleText(wep.Description, "Drenched18", 0, 32*screenscale, Color(255,255,255), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
            else
